...
def run_map_reduce1(start_date, end_date):
    ...
    for root, dirs, files in os.walk('module_wikipedia/CovidNewsTxt/timelines'):
    ...
    for file_name in valid_files:
        if len(file_name) == 11:
            ...
            year = file_name[0:4]
        cat_cmd = f'cat module_wikipedia/CovidNewsTxt/timelines/{file_name} |' 
        mapper_cmd = f'python3 module_wikipedia/utilities/mapper_timelines.py {year} | sort -nk 1 |'
        combiner_cmd = f'python3 module_wikipedia/utilities/combiner_timelines.py  &'
    ...
    cmd = cmd + f' |sort -t - -k 3,3n -k 2,2n -k 1,1n |python3 module_wikipedia/utilities/reducer_timelines.py {start_date} {end_date}'
...
def run_map_reduce2(start_date, end_date):
    ...
    for root, dirs, files in os.walk('module_wikipedia/CovidNewsTxt/responses'):
        for file_name in files:
            m_year = file_name[:-4]
    ...
    for file_name in valid_files:
        year = file_name[3:7]
        cat_cmd = f'cat module_wikipedia/CovidNewsTxt/responses/{file_name} |' 
        mapper_cmd = f'python3 module_wikipedia/utilities/mapper_responses.py {year} | sort -nk 1 |'
        combiner_cmd = f'python3 module_wikipedia/utilities/combiner_responses.py  ;'
    ...
    cmd = cmd + f' |sort -t - -k 3,3n -k 2,2n -k 1,1n |python3 module_wikipedia/utilities/reducer_responses.py {start_date} {end_date}'
...
def run_map_reduce3(start_date, end_date, country_name):
    ...
    for root, dirs, files in os.walk('module_wikipedia/CovidNewsTxt/countries'):
        for file_name in files:
    ...
    for file_name in valid_files:
        year = file_name[-8:-4]
        cat_cmd = f'cat module_wikipedia/CovidNewsTxt/countries/{file_name} |' 
        mapper_cmd = f'python3 module_wikipedia/utilities/mapper_countries.py {year} | sort -nk 1 |'
        combiner_cmd = f'python3 module_wikipedia/utilities/combiner_countries.py  &'
    ...
    cmd = cmd + f' |sort -t - -k 3,3n -k 2,2n -k 1,1n |python3 module_wikipedia/utilities/reducer_countries.py {start_date} {end_date}'
...
def jaccard_similarity(start_date, end_date, current_country_name):
    ...
    print(f'\n{current_country_name} has highest Jaccard Similarity with {max_key}\nJaccard Similarity: {max_value}')
        ...
        if(user == 5):
            ...
            while True:
                ...
                if(ip == 2):
                    ...
                    print("\ne.g. Australia | England | India | Malaysia | Singapore")
                    ...
                    countries_date_range = {'Australia':'January 2020 to May 2022',
                                            ...
                                            'Malaysia': 'January 2020 to March 2024',
